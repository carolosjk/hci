	...
	<div class="about-box">
    	<div class="container">
            ...
            <div class="section-title text-center">
                <p class="lead" style="padding-top:30px;"> Παρακάτω παρατίθενται λεπτομέρειες σχετικά με την ιστορία και το διοικητικό συμβούλιο του ΟΑΣΑ, καθώς και τα μέσα που υπάγονται σε αυτόν και τις περιοχές που εξυπηρετούν.</p>
            </div>
            ...
            <div class="row">
                <div class="item">
					<div class="single-feature" style="margin-top: 50px; pointer-events: none;">
                            <h4 style="text-align: center;">Μέσα που Υπάγονται στον Οργανισμό</h4>
                            <p style="text-align: center;"> Η Ο.Α.Σ.Α. Α.Ε. είναι ο μοναδικός μέτοχος των εταιρειών παροχής συγκοινωνιακού έργου, «ΟΔΙΚΕΣ ΣΥΓΚΟΙΝΩΝΙΕΣ» (Ο.ΣΥ. Α.Ε) αρμόδια για τη λειτουργία των Λεωφορείων και των Τρόλεϊ και 
                            «ΣΤΑΘΕΡΕΣ ΣΥΓΚΟΙΝΩΝΙΕΣ» (ΣΤΑ.ΣΥ. Α.Ε), αρμόδια για τη λειτουργία των γραμμών 1 (πρώην ηλεκτρικός σιδηρόδρομος), 2 & 3 του ΜΕΤΡΟ και του Τραμ. Οι τρεις εταιρείες αποτελούν τον Όμιλο Ο.Α.Σ.Α.</p>
					</div> 
				</div>
            </div>
