	...
	<div id="support" class="section wb" style="padding-top:100px;">
        <div class="container">
            ...
            <div class="section-title text-center">
                ...
                <br>Θα απαντήσουμε στο αίτημα σας όσο το δυνατόν γρηγορότερα και αποτελεσματικά μπορούμε!<br>
                 Αν έχετε κάποια ερώτηση μπορείτε να ενημερωθείτε και <a href="faq.php" target="_blank" rel="noopener noreferrer" style="color: #00599C;">εδώ</a>.</p>
            </div>
