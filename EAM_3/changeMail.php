						...
						<ul id="userProf_UL_29">
							<li id="userProf_LI_30">
                                ...
                                <a href="#" onclick="openP()" id="userProf_A_31">Διαγραφή Λογαριασμού</a></i></h4>
                                            ...
                                            <div class="form-popup" id="deltp" style="display: none; position: fixed; top: 34%; right: 18%; border: 4px solid #f1f1f1; z-index: 9;">
                                                <form action="php_utils/deleteAccount.php" class="form-container">
                                                    ...
                                                    <button type="submit" class="btn" style="display:center;margin-left: 352px;margin-right:5px;">Ναι</button>
